  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Import suppliers from QuickBooks</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-1">
          <div className="rounded-lg border bg-muted/20 px-4 py-3 text-sm text-muted-foreground space-y-2">
            ...
            <ol className="list-decimal pl-4 space-y-1">
              <li>
                In QuickBooks: <span className="font-medium text-foreground">Expenses → Suppliers</span>.
              </li>
              <li>Export the supplier list to Excel (.xls).</li>
              <li>
                Expected columns: Supplier, Company name, Street Address, City, State, Country,
                Zip, Phone, Email, Currency, Attachments, Open Balance.
              </li>
            ...
            {parsing ? (
              ...
              <>
                ...
                <span className="text-xs text-muted-foreground">
                  Supports QuickBooks vendor/supplier exports
                </span>
              </>
            )}
          </button>
